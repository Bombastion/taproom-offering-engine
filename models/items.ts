...
export class Item {
    ...
    constructor(id: string| null, internalName: string| null, displayName: string| null, breweryId: string | null| null, style: string| null, abv: number| null, description: string| null, menuCategory: string| null) {
        this.id = id;
